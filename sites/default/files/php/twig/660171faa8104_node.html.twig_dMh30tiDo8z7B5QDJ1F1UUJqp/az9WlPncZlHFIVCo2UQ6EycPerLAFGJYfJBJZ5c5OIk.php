...
/* themes/themes/custom/ppwg/templates/node/node.html.twig */
class __TwigTemplate_ff2b3e1d9b19c656ce7733ceca05e31a extends Template
{
    private $source;
    private $macros = [];
...
";
        // line 3
        $context["classes"] = [\Drupal\Component\Utility\Html::getClass($this->sandbox->ensureToStringAllowed(twig_get_attribute($this->env, $this->source,         // line 4
($context["node"] ?? null), "bundle", [], "any", false, false, true, 4), 4, $this->source)), ((twig_get_attribute($this->env, $this->source,         // line 5
($context["node"] ?? null), "isPromoted", [], "method", false, false, true, 5)) ? ("is-promoted") : ("")), ((twig_get_attribute($this->env, $this->source,         // line 6
($context["node"] ?? null), "isSticky", [], "method", false, false, true, 6)) ? ("is-sticky") : ("")), (( !twig_get_attribute($this->env, $this->source,         // line 7
($context["node"] ?? null), "isPublished", [], "method", false, false, true, 7)) ? ("is-unpublished") : ("")), ((        // line 8
($context["view_mode"] ?? null)) ? (\Drupal\Component\Utility\Html::getClass($this->sandbox->ensureToStringAllowed(($context["view_mode"] ?? null), 8, $this->source))) : ("")), "clearfix"];
        // line 12
        echo "<article";
  ...
  ";
      ...
      <div";
            // line 25
            echo $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed(twig_get_attribute($this->env, $this->source, ($context["author_attributes"] ?? null), "addClass", ["author"], "method", false, false, true, 25), 25, $this->source), "html", null, true);
            echo ">
        ";
            // line 26
  ...
  <div";
        // line 32
        echo $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed(twig_get_attribute($this->env, $this->source, ($context["content_attributes"] ?? null), "addClass", ["content"], "method", false, false, true, 32), 32, $this->source), "html", null, true);
        echo ">
    ";
        // line 33
...
";
    ...
    {
        return "themes/themes/custom/ppwg/templates/node/node.html.twig";
    }
    ...
    {
        return new Source("", "themes/themes/custom/ppwg/templates/node/node.html.twig", "/opt/drupal/web/themes/themes/custom/ppwg/templates/node/node.html.twig");
    }
