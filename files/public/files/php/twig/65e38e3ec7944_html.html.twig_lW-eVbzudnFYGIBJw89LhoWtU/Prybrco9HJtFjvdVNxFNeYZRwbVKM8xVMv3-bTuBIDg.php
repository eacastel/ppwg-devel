...
/* themes/custom/ppwg/templates/system/html.html.twig */
class __TwigTemplate_049f2132218e3a6cb5ec387e7a939da2 extends Template
{
    private $source;
    private $macros = [];
...
($context["db_offline"] ?? null)) ? ("db-offline") : ("")), 4 => ((twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source,         // line 8
($context["theme"] ?? null), "settings", [], "any", false, false, true, 8), "navbar_position", [], "any", false, false, true, 8)) ? (("navbar-is-" . $this->sandbox->ensureToStringAllowed(twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, ($context["theme"] ?? null), "settings", [], "any", false, false, true, 8), "navbar_position", [], "any", false, false, true, 8), 8, $this->source))) : ("")), 5 => ((twig_get_attribute($this->env, $this->source,         // line 9
...
<html ";
  ...
  <body";
        // line 20
        echo $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed(twig_get_attribute($this->env, $this->source, ($context["attributes"] ?? null), "addClass", [0 => ($context["body_classes"] ?? null), 1 => ((($context["node_id"] ?? null)) ? (("node-" . $this->sandbox->ensureToStringAllowed(($context["node_id"] ?? null), 20, $this->source))) : (""))], "method", false, false, true, 20), 20, $this->source), "html", null, true);
        echo ">
...
";
    ...
    {
        return "themes/custom/ppwg/templates/system/html.html.twig";
    }
    ...
    {
        return new Source("", "themes/custom/ppwg/templates/system/html.html.twig", "/opt/drupal/web/themes/custom/ppwg/templates/system/html.html.twig");
    }
